...
class GroupActivityLocalDataSourceImpl
@Inject
constructor(
    ...
    override fun observeByGroupId(
        localGroupId: Long
    ): Flow<List<GroupActivityEntity>> = groupActivityDao.getActivitiesByGroupId(localGroupId)

    override suspend fun getByGroupIdOnce(localGroupId: Long): List<GroupActivityEntity> = groupActivityDao.getActivitiesByGroupIdOnce(
        localGroupId
    )
